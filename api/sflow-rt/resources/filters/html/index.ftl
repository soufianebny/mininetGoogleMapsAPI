...
through the <a target="_blank" href="http://sflow-rt.com/reference.php">REST and JavaScript APIs</a>. Visit <a target="_blank" href="http://www.sflow-rt.com">sFlow-RT.com</a> for documentation, software, and community support.</p>
<p><a target="_blank" href="../api/">OpenAPI 2.0</a> specification of sFlow-RT REST API.</p>
<#if licenseType == "non-production">
<p>For startup settings, see <a target="_blank" href="http://sflow-rt.com/reference.php#properties">System Properties</a>. The default memory setting in the startup script is optimized for small deployments and must be increased for large scale installations.</p>
</#if>
