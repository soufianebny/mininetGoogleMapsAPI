...
class MininetRest(Bottle):
    ...
    def __init__(self, net):
        ...
        self.route('/nodes/<node_name>', method=['POST', 'OPTIONS'], callback=self.post_node)
        ...
        self.route('/nodes/<node_name>/<intf_name>', method=['POST', 'OPTIONS'], callback=self.post_intf)
        ...
        self.route('/iperf/<node_name1>/<node_name2>/<type>',method=['GET', 'OPTIONS'], callback=self.iperf)
        self.route('/linksfile', method='GET', callback=self.linksfile)
        


    def linksfile(self):
    	ThisDir = os.path.dirname(os.path.realpath('__file__'))
    	fileDir = os.path.join(ThisDir, 'temp/linkslist')
        with open(fileDir,'r') as fichier:
    ...
    def iperf(self,node_name1,node_name2,type):
        a=self.net.iperf((self.net.getNodeByName(node_name1), self.net.getNodeByName(node_name2)), l4Type=type)
	return {'results':a}
